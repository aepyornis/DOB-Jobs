COPY dob_jobs TO 'D:\code\all_jobs.csv' WITH (DELIMITER ',');


COPY dob_jobs TO 'D:\code\all_jobs.csv' DELIMITER ',' CSV HEADER;



COPY (SELECT job, house, streetName, bbl, latestActionDate, jobType, ownerName, ownerBusinessName, proposedStories, proposedOccupany, jobDescription FROM dob_jobs WHERE jobType = 'A1' ORDER BY proposedStories DESC NULLS LAST) TO 'D:\code\all_jobs.csv' DELIMITER ',' CSV HEADER;
